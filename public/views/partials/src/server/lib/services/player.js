class PlayerService {
	...
	async create(data) {
		...
		const results = await this.app.db.query(query, [data.owner, data.charClass, data.bg, data.guts, data.guts, data.wits, data.wits, data.charm, data.charm, data.skillFighter, data.skillFighter, data.skillMagic, data.skillMagic, data.skillTrade, data.skillTrade, data.cash, data.rank]);

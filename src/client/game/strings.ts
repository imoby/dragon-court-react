const strings = {
  creation: {
    ...
    loc: [
      ...
      "a silk and spices trade galley",
      "the tower of bones",
      ...
      "the dungeon inspectors guild (local #422)",
      "Lady Marigolds Dance Academy",
      ...
      "an island that cant be reached by boat",
      "the endless wastes",
      "a frozen wasteland",
    ...
    desc: [
      ...
      "doesnt understand the concept of politeness",
      "always alliterates their anecdotes",
      "has a bad gambling problem",
      "was told theyll never be good enough",
      ...
      "believes theyre a demi god, but hasnt figured out who their father is yet",
      ...
      "has serious activity_game image problems",
      ...
      "doesnt know their own strength",
      "has had it up to here with everyones crap",
      ...
      "wants to prove theyre no longer that goofy kid",
      ...
      "cant seem to hold their liquor",
      ...
      "hasnt been quite right since the accident",
      "hasnt accomplished anything in their short life yet",
      ...
      "in hindsight shouldnt have had the treasure map tattooed on themselves",
      ...
      "was cut from their dead mothers womb",
      "was apprenticed to a failed alchemist",
      "was jailed for a crime they didnt commit",
      "is posing as someone else",
      "was expelled from the royal guards",
      "is the last of the kings bastard children",
      ...
      "doesnt have time for all this prophecy bullshit",
      ...
      "was born in a different activity_game",
      ...
      "carries a charmed locket that they cant open",
      "is getting too old for all this",
      "no longer dreams",
      "rejected a foreign princes marriage proposal",
      ...
      "isnt technically alive anymore",
      "is convinced theyre always being left out",
      "doesnt speak a word of common",
    ],
  },
  awaken: {
    first:
      "You arrive in Town one sunny morning, ready to begin your adventure.",
    start: "You awaken ",
    place: {
    ...
    location: {
      floor:
        "aching head to toe from sleeping on the hard wooden floor. You slowly move around and break your fast.",
